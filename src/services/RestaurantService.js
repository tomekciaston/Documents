...
class RestaurantService {
    ...
    async top() {
        return await this.restaurantRepository.top()
    }

    async search(query) {
        return await this.restaurantRepository.search(query)
    }

    async topDeliverers() {
        return await this.restaurantRepository.topDeliverers()
    }

    async bottomDeliverers() {
        return await this.restaurantRepository.bottomDeliverers()
    }
